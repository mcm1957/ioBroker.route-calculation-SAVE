...
const adapter = new utils.Adapter('route-calculation');
...
function getChannels() {  // Fill arrays and objects for comparing configured vs existing routes
    ...
    adapter.getObjectView('route-calculation', 'listRouteIDs',
        { startkey: 'route-calculation.' + adapter.instance + '.', endkey: 'route-calculation.' + adapter.instance + '.\u9999' },
        function (err, doc) {
            if (!err && doc) {
                try {
